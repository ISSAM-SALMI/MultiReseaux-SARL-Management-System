...
from .views import QuoteViewSet, QuoteLineViewSet, QuoteTrackingViewSet, QuoteTrackingLineViewSet, QuoteGroupViewSet, QuoteTrackingGroupViewSet

router = DefaultRouter()
router.register(r'tracking-groups', QuoteTrackingGroupViewSet)
